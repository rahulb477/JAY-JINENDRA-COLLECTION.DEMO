...
const PAGES: Record<string, { title: string; body: { h: string; p: string }[] }> = {
  contact: {
    ...
    body: [
      ...
      { h: "Email", p: `${STORE.email} — for wholesale enquiries, bulk orders and delivery questions.` },
      { h: "Instagram", p: "@jai_jinendra_collection__ — DM us for new drops and reel products. Facebook: Jai Jinendra Collection." },
    ],
  },
  shipping: {
    title: "Shipping Policy",
    body: [
      { h: "Delivery areas", p: "We deliver across India. Jodhpur orders are usually delivered in 2–5 days; other cities in 4–7 days. Store pickup is available at Sarafa Bazaar." },
  ...
  faq: {
    ...
    body: [
      ...
      { h: "Can I pick up from store?", p: "Yes — choose STORE PICKUP at checkout. Same-day pickup at Sarafa Bazaar, near PNB ATM." },
...
export default async function InfoPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      <p className="text-[11px] font-bold tracking-[0.3em] text-[#9a7420]">CUSTOMER CARE</p>
      ...
      <div className="mt-6 flex flex-wrap gap-2">
        ...
        <Link href="/store" className="px-6 py-3 rounded-xl bg-black text-[#e8c877] text-[12px] font-extrabold">VISIT STORE</Link>
      </div>
    </div>
  );
}
