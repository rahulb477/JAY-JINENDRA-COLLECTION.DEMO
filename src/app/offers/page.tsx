  ...
  return (
    <div className="max-w-[1400px] mx-auto px-4 sm:px-6 py-8 sm:py-12">
      <div className="text-center">
        <p className="text-[11px] font-bold tracking-[0.3em] text-[#9a7420] flex items-center justify-center gap-1.5"><BadgePercent size={14} /> LIMITED TIME</p>
        ...
        {offers.map((o) => (
          <Link key={o.id} href={o.ctaLink || "/shop"} className="group relative block rounded-3xl overflow-hidden aspect-[4/5] img-zoom">
            ...
            <div className="absolute bottom-0 p-6">
              ...
              <span className="inline-flex items-center gap-2 mt-4 px-6 py-3 rounded-xl bg-white text-black text-[12px] font-extrabold group-hover:bg-[#c9a24b] transition">{o.ctaText || "SHOP NOW"} <ArrowRight size={14} /></span>
            </div>
          </Link>
        ))}
      </div>
